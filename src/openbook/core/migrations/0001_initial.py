    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modified At')),
                ('duration_period', models.CharField(choices=[('minutes', 'Minutes'), ('hours', 'Hours'), ('days', 'Days'), ('weeks', 'Weeks'), ('months', 'Months'), ('years', 'Years')], max_length=10, verbose_name='Duration Period')),
                ('duration_value', models.FloatField(verbose_name='Duration Value')),
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('text_format', models.CharField(default='MD', max_length=10, verbose_name='Text Format')),
                ('scope_uuid', models.UUIDField(verbose_name='Scope UUID')),
                ('has_end_date', models.BooleanField(default=False, verbose_name='Has Enrollment End')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modified At')),
                ('has_start_date', models.BooleanField(default=False, verbose_name='Has start date')),
                ('start_date', models.DateTimeField(blank=True, null=True, verbose_name='Start date and time')),
                ('has_end_date', models.BooleanField(default=False, verbose_name='Has end date')),
        ...
        migrations.AddConstraint(
            model_name='role',
            constraint=models.UniqueConstraint(fields=('scope_type', 'scope_uuid', 'slug'), name='unique_role_slug'),
        ),
        migrations.AddConstraint(
