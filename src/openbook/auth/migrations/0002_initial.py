...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='access_request',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='role_assignment', to='openbook_auth.accessrequest'),
        ),
        migrations.AddField(
            model_name='roleassignment',
            name='created_by',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='role_assignments', to='openbook_auth.enrollmentmethod'),
        ),
        migrations.AddField(
            model_name='roleassignment',
            name='modified_by',
