    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_template', models.BooleanField(help_text='Flag indicating that this course is not used productively but rather is a template for creating similar courses.', verbose_name='Is Template')),
                ...
                ('owner', models.ForeignKey(blank=True, default='', help_text='The owner always has full permissions', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
