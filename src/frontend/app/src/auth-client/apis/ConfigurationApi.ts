...
export interface AuthApiClientV1ConfigGetRequest {
    client: AuthApiClientV1ConfigGetClientEnum;
}
...
export class ConfigurationApi extends runtime.BaseAPI {
     ...
     * Get configuration
     */
    async authApiClientV1ConfigGetRaw(requestParameters: AuthApiClientV1ConfigGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigurationResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1ConfigGet().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/config`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'GET',
     ...
     * Get configuration
     */
    async authApiClientV1ConfigGet(requestParameters: AuthApiClientV1ConfigGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConfigurationResponse> {
        const response = await this.authApiClientV1ConfigGetRaw(requestParameters, initOverrides);
 ...
 * @export
 */
export const AuthApiClientV1ConfigGetClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1ConfigGetClientEnum = typeof AuthApiClientV1ConfigGetClientEnum[keyof typeof AuthApiClientV1ConfigGetClientEnum];
