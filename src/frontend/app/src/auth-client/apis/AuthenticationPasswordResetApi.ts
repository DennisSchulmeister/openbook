...
import type {
  ...
  AuthApiClientV1AuthPasswordResetGet200Response,
...
import {
    ...
    AuthApiClientV1AuthPasswordResetGet200ResponseFromJSON,
    AuthApiClientV1AuthPasswordResetGet200ResponseToJSON,
...
export interface AuthApiClientV1AuthPasswordRequestPostRequest {
    client: AuthApiClientV1AuthPasswordRequestPostClientEnum;
    requestPassword: RequestPassword;
}

export interface AuthApiClientV1AuthPasswordResetGetRequest {
    client: AuthApiClientV1AuthPasswordResetGetClientEnum;
    xPasswordResetKey: string;
}

export interface AuthApiClientV1AuthPasswordResetPostRequest {
    client: AuthApiClientV1AuthPasswordResetPostClientEnum;
...
export class AuthenticationPasswordResetApi extends runtime.BaseAPI {
     ...
     * Request password
     */
    async authApiClientV1AuthPasswordRequestPostRaw(requestParameters: AuthApiClientV1AuthPasswordRequestPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthApiClientV1AuthEmailVerifyResendPost200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthPasswordRequestPost().'
            );
        }
        ...
        if (requestParameters['requestPassword'] == null) {
            throw new runtime.RequiredError(
                'requestPassword',
                'Required parameter "requestPassword" was null or undefined when calling authApiClientV1AuthPasswordRequestPost().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/auth/password/request`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
     ...
     * Request password
     */
    async authApiClientV1AuthPasswordRequestPost(requestParameters: AuthApiClientV1AuthPasswordRequestPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthApiClientV1AuthEmailVerifyResendPost200Response> {
        const response = await this.authApiClientV1AuthPasswordRequestPostRaw(requestParameters, initOverrides);
     ...
     */
    async authApiClientV1AuthPasswordResetGetRaw(requestParameters: AuthApiClientV1AuthPasswordResetGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthApiClientV1AuthPasswordResetGet200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthPasswordResetGet().'
            );
        }
        ...
        if (requestParameters['xPasswordResetKey'] == null) {
            throw new runtime.RequiredError(
                'xPasswordResetKey',
                'Required parameter "xPasswordResetKey" was null or undefined when calling authApiClientV1AuthPasswordResetGet().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/auth/password/reset`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => AuthApiClientV1AuthPasswordResetGet200ResponseFromJSON(jsonValue));
    }
     ...
     * Get password reset information
     */
    async authApiClientV1AuthPasswordResetGet(requestParameters: AuthApiClientV1AuthPasswordResetGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthApiClientV1AuthPasswordResetGet200Response> {
        const response = await this.authApiClientV1AuthPasswordResetGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Reset password
     */
    async authApiClientV1AuthPasswordResetPostRaw(requestParameters: AuthApiClientV1AuthPasswordResetPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthPasswordResetPost().'
            );
        }
     ...
     * Reset password
     */
    async authApiClientV1AuthPasswordResetPost(requestParameters: AuthApiClientV1AuthPasswordResetPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthenticatedResponse> {
        const response = await this.authApiClientV1AuthPasswordResetPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const AuthApiClientV1AuthPasswordRequestPostClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthPasswordRequestPostClientEnum = typeof AuthApiClientV1AuthPasswordRequestPostClientEnum[keyof typeof AuthApiClientV1AuthPasswordRequestPostClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AuthPasswordResetGetClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthPasswordResetGetClientEnum = typeof AuthApiClientV1AuthPasswordResetGetClientEnum[keyof typeof AuthApiClientV1AuthPasswordResetGetClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AuthPasswordResetPostClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthPasswordResetPostClientEnum = typeof AuthApiClientV1AuthPasswordResetPostClientEnum[keyof typeof AuthApiClientV1AuthPasswordResetPostClientEnum];
