...
import type {
  AuthApiClientV1AccountProvidersDeleteRequest,
  AuthApiClientV1AccountProvidersGet200Response,
  ErrorResponse,
} from '../models/index';
import {
    AuthApiClientV1AccountProvidersDeleteRequestFromJSON,
    AuthApiClientV1AccountProvidersDeleteRequestToJSON,
    AuthApiClientV1AccountProvidersGet200ResponseFromJSON,
    AuthApiClientV1AccountProvidersGet200ResponseToJSON,
    ErrorResponseFromJSON,
    ErrorResponseToJSON,
} from '../models/index';

export interface AuthApiClientV1AccountProvidersDeleteOperationRequest {
    client: AuthApiClientV1AccountProvidersDeleteOperationClientEnum;
    xSessionToken?: string;
    authApiClientV1AccountProvidersDeleteRequest?: AuthApiClientV1AccountProvidersDeleteRequest;
}

export interface AuthApiClientV1AccountProvidersGetRequest {
    client: AuthApiClientV1AccountProvidersGetClientEnum;
    xSessionToken?: string;
}
...
export class AccountProvidersApi extends runtime.BaseAPI {
     ...
     */
    async authApiClientV1AccountProvidersDeleteRaw(requestParameters: AuthApiClientV1AccountProvidersDeleteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthApiClientV1AccountProvidersGet200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AccountProvidersDelete().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/account/providers`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
            body: AuthApiClientV1AccountProvidersDeleteRequestToJSON(requestParameters['authApiClientV1AccountProvidersDeleteRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => AuthApiClientV1AccountProvidersGet200ResponseFromJSON(jsonValue));
    }
     ...
     * Disconnect a third-party provider account 
     */
    async authApiClientV1AccountProvidersDelete(requestParameters: AuthApiClientV1AccountProvidersDeleteOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthApiClientV1AccountProvidersGet200Response> {
        const response = await this.authApiClientV1AccountProvidersDeleteRaw(requestParameters, initOverrides);
     ...
     */
    async authApiClientV1AccountProvidersGetRaw(requestParameters: AuthApiClientV1AccountProvidersGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthApiClientV1AccountProvidersGet200Response>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AccountProvidersGet().'
            );
        }
     ...
     * List the connected third-party provider accounts
     */
    async authApiClientV1AccountProvidersGet(requestParameters: AuthApiClientV1AccountProvidersGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthApiClientV1AccountProvidersGet200Response> {
        const response = await this.authApiClientV1AccountProvidersGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const AuthApiClientV1AccountProvidersDeleteOperationClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AccountProvidersDeleteOperationClientEnum = typeof AuthApiClientV1AccountProvidersDeleteOperationClientEnum[keyof typeof AuthApiClientV1AccountProvidersDeleteOperationClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AccountProvidersGetClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AccountProvidersGetClientEnum = typeof AuthApiClientV1AccountProvidersGetClientEnum[keyof typeof AuthApiClientV1AccountProvidersGetClientEnum];
