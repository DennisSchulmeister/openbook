...
import type {
  ...
  AuthApiClientV1AccountPhonePostRequest,
...
import {
    ...
    AuthApiClientV1AccountPhonePostRequestFromJSON,
    AuthApiClientV1AccountPhonePostRequestToJSON,
...
export interface AuthApiClientV1AccountPhoneGetRequest {
    client: AuthApiClientV1AccountPhoneGetClientEnum;
    xSessionToken?: string;
}

export interface AuthApiClientV1AccountPhonePostOperationRequest {
    client: AuthApiClientV1AccountPhonePostOperationClientEnum;
    xSessionToken?: string;
    authApiClientV1AccountPhonePostRequest?: AuthApiClientV1AccountPhonePostRequest;
}
...
export class AccountPhoneApi extends runtime.BaseAPI {
     ...
     */
    async authApiClientV1AccountPhoneGetRaw(requestParameters: AuthApiClientV1AccountPhoneGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumbersResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AccountPhoneGet().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/account/phone`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'GET',
     ...
     * Get the phone number
     */
    async authApiClientV1AccountPhoneGet(requestParameters: AuthApiClientV1AccountPhoneGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PhoneNumbersResponse> {
        const response = await this.authApiClientV1AccountPhoneGetRaw(requestParameters, initOverrides);
     ...
     */
    async authApiClientV1AccountPhonePostRaw(requestParameters: AuthApiClientV1AccountPhonePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumberChangeResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AccountPhonePost().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AuthApiClientV1AccountPhonePostRequestToJSON(requestParameters['authApiClientV1AccountPhonePostRequest']),
        }, initOverrides);
     ...
     * Change the phone number 
     */
    async authApiClientV1AccountPhonePost(requestParameters: AuthApiClientV1AccountPhonePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PhoneNumberChangeResponse> {
        const response = await this.authApiClientV1AccountPhonePostRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const AuthApiClientV1AccountPhoneGetClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AccountPhoneGetClientEnum = typeof AuthApiClientV1AccountPhoneGetClientEnum[keyof typeof AuthApiClientV1AccountPhoneGetClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AccountPhonePostOperationClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AccountPhonePostOperationClientEnum = typeof AuthApiClientV1AccountPhonePostOperationClientEnum[keyof typeof AuthApiClientV1AccountPhonePostOperationClientEnum];
