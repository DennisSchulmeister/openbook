...
export interface AuthApiClientV1AuthSessionDeleteRequest {
    client: AuthApiClientV1AuthSessionDeleteClientEnum;
    xSessionToken?: string;
}

export interface AuthApiClientV1AuthSessionGetRequest {
    client: AuthApiClientV1AuthSessionGetClientEnum;
    xSessionToken?: string;
}
...
export class AuthenticationCurrentSessionApi extends runtime.BaseAPI {
     ...
     * Logout
     */
    async authApiClientV1AuthSessionDeleteRaw(requestParameters: AuthApiClientV1AuthSessionDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthSessionDelete().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/auth/session`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'DELETE',
     ...
     * Logout
     */
    async authApiClientV1AuthSessionDelete(requestParameters: AuthApiClientV1AuthSessionDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.authApiClientV1AuthSessionDeleteRaw(requestParameters, initOverrides);
    }
     ...
     */
    async authApiClientV1AuthSessionGetRaw(requestParameters: AuthApiClientV1AuthSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthenticatedResponse>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AuthSessionGet().'
            );
        }
     ...
     * Get authentication status 
     */
    async authApiClientV1AuthSessionGet(requestParameters: AuthApiClientV1AuthSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthenticatedResponse> {
        const response = await this.authApiClientV1AuthSessionGetRaw(requestParameters, initOverrides);
 ...
 * @export
 */
export const AuthApiClientV1AuthSessionDeleteClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthSessionDeleteClientEnum = typeof AuthApiClientV1AuthSessionDeleteClientEnum[keyof typeof AuthApiClientV1AuthSessionDeleteClientEnum];
/**
 * @export
 */
export const AuthApiClientV1AuthSessionGetClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AuthSessionGetClientEnum = typeof AuthApiClientV1AuthSessionGetClientEnum[keyof typeof AuthApiClientV1AuthSessionGetClientEnum];
