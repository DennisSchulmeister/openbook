...
import type {
  AuthApiClientV1AccountPasswordChangePostRequest,
  AuthenticationResponse,
  ErrorResponse,
} from '../models/index';
import {
    AuthApiClientV1AccountPasswordChangePostRequestFromJSON,
    AuthApiClientV1AccountPasswordChangePostRequestToJSON,
...
export interface AuthApiClientV1AccountPasswordChangePostOperationRequest {
    client: AuthApiClientV1AccountPasswordChangePostOperationClientEnum;
    xSessionToken?: string;
    authApiClientV1AccountPasswordChangePostRequest?: AuthApiClientV1AccountPasswordChangePostRequest;
}
...
export class AccountPasswordApi extends runtime.BaseAPI {
     ...
     * Change password
     */
    async authApiClientV1AccountPasswordChangePostRaw(requestParameters: AuthApiClientV1AccountPasswordChangePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling authApiClientV1AccountPasswordChangePost().'
            );
        }
        ...
        const response = await this.request({
            path: `/auth-api/{client}/v1/account/password/change`.replace(`{${"client"}}`, encodeURIComponent(String(requestParameters['client']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: AuthApiClientV1AccountPasswordChangePostRequestToJSON(requestParameters['authApiClientV1AccountPasswordChangePostRequest']),
        }, initOverrides);
     ...
     * Change password
     */
    async authApiClientV1AccountPasswordChangePost(requestParameters: AuthApiClientV1AccountPasswordChangePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.authApiClientV1AccountPasswordChangePostRaw(requestParameters, initOverrides);
    }
 ...
 * @export
 */
export const AuthApiClientV1AccountPasswordChangePostOperationClientEnum = {
    App: 'app',
    Browser: 'browser'
} as const;
export type AuthApiClientV1AccountPasswordChangePostOperationClientEnum = typeof AuthApiClientV1AccountPasswordChangePostOperationClientEnum[keyof typeof AuthApiClientV1AccountPasswordChangePostOperationClientEnum];
