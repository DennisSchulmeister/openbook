 ...
 * 
 * @export
 * @interface InlineObject5Meta
 */
export interface InlineObject5Meta {
    /**
     * A TOTP secret that can be used to setup a new authenticator.
     * 
     * @type {string}
     * @memberof InlineObject5Meta
     */
    secret: string;
    /**
...
/**
 * Check if a given object implements the InlineObject5Meta interface.
 */
export function instanceOfInlineObject5Meta(value: object): value is InlineObject5Meta {
    if (!('secret' in value) || value['secret'] === undefined) return false;
    if (!('totpUrl' in value) || value['totpUrl'] === undefined) return false;
    return true;
}

export function InlineObject5MetaFromJSON(json: any): InlineObject5Meta {
    return InlineObject5MetaFromJSONTyped(json, false);
}

export function InlineObject5MetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject5Meta {
    if (json == null) {
        return json;
    }
    return {
...
export function InlineObject5MetaToJSON(json: any): InlineObject5Meta {
    return InlineObject5MetaToJSONTyped(json, false);
}

export function InlineObject5MetaToJSONTyped(value?: InlineObject5Meta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
