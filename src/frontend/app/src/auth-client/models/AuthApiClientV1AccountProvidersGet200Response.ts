 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountProvidersGet200Response
 */
export interface AuthApiClientV1AccountProvidersGet200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AuthApiClientV1AccountProvidersGet200Response
     */
    status: StatusOK;
    /**
     * 
...
/**
 * Check if a given object implements the AuthApiClientV1AccountProvidersGet200Response interface.
 */
export function instanceOfAuthApiClientV1AccountProvidersGet200Response(value: object): value is AuthApiClientV1AccountProvidersGet200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountProvidersGet200ResponseFromJSON(json: any): AuthApiClientV1AccountProvidersGet200Response {
    return AuthApiClientV1AccountProvidersGet200ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountProvidersGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountProvidersGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountProvidersGet200ResponseToJSON(json: any): AuthApiClientV1AccountProvidersGet200Response {
    return AuthApiClientV1AccountProvidersGet200ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AccountProvidersGet200ResponseToJSONTyped(value?: AuthApiClientV1AccountProvidersGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
