 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthProviderSignupGet200ResponseData
 */
export interface AuthApiClientV1AuthProviderSignupGet200ResponseData {
    /**
     * 
     * @type {Array<EmailAddress>}
     * @memberof AuthApiClientV1AuthProviderSignupGet200ResponseData
     */
...
/**
 * Check if a given object implements the AuthApiClientV1AuthProviderSignupGet200ResponseData interface.
 */
export function instanceOfAuthApiClientV1AuthProviderSignupGet200ResponseData(value: object): value is AuthApiClientV1AuthProviderSignupGet200ResponseData {
...
export function AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSON(json: any): AuthApiClientV1AuthProviderSignupGet200ResponseData {
    return AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthProviderSignupGet200ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSON(json: any): AuthApiClientV1AuthProviderSignupGet200ResponseData {
    return AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSONTyped(json, false);
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSONTyped(value?: AuthApiClientV1AuthProviderSignupGet200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
