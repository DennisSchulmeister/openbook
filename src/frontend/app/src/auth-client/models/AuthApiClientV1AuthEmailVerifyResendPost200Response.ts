 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthEmailVerifyResendPost200Response
 */
export interface AuthApiClientV1AuthEmailVerifyResendPost200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AuthApiClientV1AuthEmailVerifyResendPost200Response
     */
    status: StatusOK;
}
...
/**
 * Check if a given object implements the AuthApiClientV1AuthEmailVerifyResendPost200Response interface.
 */
export function instanceOfAuthApiClientV1AuthEmailVerifyResendPost200Response(value: object): value is AuthApiClientV1AuthEmailVerifyResendPost200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AuthEmailVerifyResendPost200ResponseFromJSON(json: any): AuthApiClientV1AuthEmailVerifyResendPost200Response {
    return AuthApiClientV1AuthEmailVerifyResendPost200ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthEmailVerifyResendPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthEmailVerifyResendPost200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AuthEmailVerifyResendPost200ResponseToJSON(json: any): AuthApiClientV1AuthEmailVerifyResendPost200Response {
    return AuthApiClientV1AuthEmailVerifyResendPost200ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AuthEmailVerifyResendPost200ResponseToJSONTyped(value?: AuthApiClientV1AuthEmailVerifyResendPost200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
