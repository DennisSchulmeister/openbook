 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountPasswordChangePostRequest
 */
export interface AuthApiClientV1AccountPasswordChangePostRequest {
    /**
     * The password.
     * 
     * @type {string}
     * @memberof AuthApiClientV1AccountPasswordChangePostRequest
     */
...
/**
 * Check if a given object implements the AuthApiClientV1AccountPasswordChangePostRequest interface.
 */
export function instanceOfAuthApiClientV1AccountPasswordChangePostRequest(value: object): value is AuthApiClientV1AccountPasswordChangePostRequest {
    if (!('newPassword' in value) || value['newPassword'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountPasswordChangePostRequestFromJSON(json: any): AuthApiClientV1AccountPasswordChangePostRequest {
    return AuthApiClientV1AccountPasswordChangePostRequestFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountPasswordChangePostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountPasswordChangePostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountPasswordChangePostRequestToJSON(json: any): AuthApiClientV1AccountPasswordChangePostRequest {
    return AuthApiClientV1AccountPasswordChangePostRequestToJSONTyped(json, false);
}

export function AuthApiClientV1AccountPasswordChangePostRequestToJSONTyped(value?: AuthApiClientV1AccountPasswordChangePostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
