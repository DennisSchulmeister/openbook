 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountEmailGet200Response
 */
export interface AuthApiClientV1AccountEmailGet200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AuthApiClientV1AccountEmailGet200Response
     */
    status: StatusOK;
    /**
     * 
...
/**
 * Check if a given object implements the AuthApiClientV1AccountEmailGet200Response interface.
 */
export function instanceOfAuthApiClientV1AccountEmailGet200Response(value: object): value is AuthApiClientV1AccountEmailGet200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountEmailGet200ResponseFromJSON(json: any): AuthApiClientV1AccountEmailGet200Response {
    return AuthApiClientV1AccountEmailGet200ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountEmailGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountEmailGet200ResponseToJSON(json: any): AuthApiClientV1AccountEmailGet200Response {
    return AuthApiClientV1AccountEmailGet200ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailGet200ResponseToJSONTyped(value?: AuthApiClientV1AccountEmailGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
