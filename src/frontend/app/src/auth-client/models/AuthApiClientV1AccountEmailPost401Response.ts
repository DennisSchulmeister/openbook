...
/**
 * @type AuthApiClientV1AccountEmailPost401Response
 * 
 * @export
 */
export type AuthApiClientV1AccountEmailPost401Response = AuthenticationResponse | ReauthenticationResponse;

export function AuthApiClientV1AccountEmailPost401ResponseFromJSON(json: any): AuthApiClientV1AccountEmailPost401Response {
    return AuthApiClientV1AccountEmailPost401ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPost401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountEmailPost401Response {
    if (json == null) {
        return json;
    }
...
export function AuthApiClientV1AccountEmailPost401ResponseToJSON(json: any): any {
    return AuthApiClientV1AccountEmailPost401ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPost401ResponseToJSONTyped(value?: AuthApiClientV1AccountEmailPost401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
