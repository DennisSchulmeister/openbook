 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountPhonePostRequest
 */
export interface AuthApiClientV1AccountPhonePostRequest {
    /**
     * 
     * @type {string}
     * @memberof AuthApiClientV1AccountPhonePostRequest
     */
    phone: string;
}

/**
 * Check if a given object implements the AuthApiClientV1AccountPhonePostRequest interface.
 */
export function instanceOfAuthApiClientV1AccountPhonePostRequest(value: object): value is AuthApiClientV1AccountPhonePostRequest {
    if (!('phone' in value) || value['phone'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountPhonePostRequestFromJSON(json: any): AuthApiClientV1AccountPhonePostRequest {
    return AuthApiClientV1AccountPhonePostRequestFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountPhonePostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountPhonePostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountPhonePostRequestToJSON(json: any): AuthApiClientV1AccountPhonePostRequest {
    return AuthApiClientV1AccountPhonePostRequestToJSONTyped(json, false);
}

export function AuthApiClientV1AccountPhonePostRequestToJSONTyped(value?: AuthApiClientV1AccountPhonePostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
