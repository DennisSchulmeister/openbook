...
import type { AuthApiClientV1AuthPasswordResetGet200ResponseData } from './AuthApiClientV1AuthPasswordResetGet200ResponseData';
import {
    AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSON,
    AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSONTyped,
    AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSON,
    AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSONTyped,
} from './AuthApiClientV1AuthPasswordResetGet200ResponseData';
 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthPasswordResetGet200Response
 */
export interface AuthApiClientV1AuthPasswordResetGet200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AuthApiClientV1AuthPasswordResetGet200Response
     */
    status: StatusOK;
    /**
     * 
     * @type {AuthApiClientV1AuthPasswordResetGet200ResponseData}
     * @memberof AuthApiClientV1AuthPasswordResetGet200Response
     */
    data: AuthApiClientV1AuthPasswordResetGet200ResponseData;
}



/**
 * Check if a given object implements the AuthApiClientV1AuthPasswordResetGet200Response interface.
 */
export function instanceOfAuthApiClientV1AuthPasswordResetGet200Response(value: object): value is AuthApiClientV1AuthPasswordResetGet200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseFromJSON(json: any): AuthApiClientV1AuthPasswordResetGet200Response {
    return AuthApiClientV1AuthPasswordResetGet200ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthPasswordResetGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSON(json['data']),
    };
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseToJSON(json: any): AuthApiClientV1AuthPasswordResetGet200Response {
    return AuthApiClientV1AuthPasswordResetGet200ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseToJSONTyped(value?: AuthApiClientV1AuthPasswordResetGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSON(value['data']),
    };
}
