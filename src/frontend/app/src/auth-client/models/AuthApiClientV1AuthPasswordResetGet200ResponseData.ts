 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthPasswordResetGet200ResponseData
 */
export interface AuthApiClientV1AuthPasswordResetGet200ResponseData {
    /**
     * 
     * @type {User}
     * @memberof AuthApiClientV1AuthPasswordResetGet200ResponseData
     */
    user?: User;
}

/**
 * Check if a given object implements the AuthApiClientV1AuthPasswordResetGet200ResponseData interface.
 */
export function instanceOfAuthApiClientV1AuthPasswordResetGet200ResponseData(value: object): value is AuthApiClientV1AuthPasswordResetGet200ResponseData {
    return true;
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSON(json: any): AuthApiClientV1AuthPasswordResetGet200ResponseData {
    return AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthPasswordResetGet200ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSON(json: any): AuthApiClientV1AuthPasswordResetGet200ResponseData {
    return AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSONTyped(json, false);
}

export function AuthApiClientV1AuthPasswordResetGet200ResponseDataToJSONTyped(value?: AuthApiClientV1AuthPasswordResetGet200ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
