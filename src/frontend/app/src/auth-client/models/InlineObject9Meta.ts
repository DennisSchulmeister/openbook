 ...
 */
export function instanceOfInlineObject9Meta(value: object): value is InlineObject9Meta {
    return true;
}
...
export function InlineObject9MetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject9Meta {
    if (json == null) {
        return json;
    }
    return {
...
export function InlineObject9MetaToJSONTyped(value?: InlineObject9Meta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
