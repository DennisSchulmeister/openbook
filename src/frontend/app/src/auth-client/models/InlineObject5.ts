...
import type { InlineObject5Meta } from './InlineObject5Meta';
import {
    InlineObject5MetaFromJSON,
    InlineObject5MetaFromJSONTyped,
    InlineObject5MetaToJSON,
    InlineObject5MetaToJSONTyped,
} from './InlineObject5Meta';
...
export interface InlineObject5 {
    ...
    /**
     * 
     * @type {InlineObject5Meta}
     * @memberof InlineObject5
     */
    meta: InlineObject5Meta;
}
 ...
 * @export
 */
export const InlineObject5StatusEnum = {
    NUMBER_404: 404
} as const;
export type InlineObject5StatusEnum = typeof InlineObject5StatusEnum[keyof typeof InlineObject5StatusEnum];
...
export function InlineObject5FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject5 {
    ...
    return {
        ...
        'status': json['status'],
        'meta': InlineObject5MetaFromJSON(json['meta']),
    };
}
...
export function InlineObject5ToJSONTyped(value?: InlineObject5 | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'status': value['status'],
        'meta': InlineObject5MetaToJSON(value['meta']),
    };
}
