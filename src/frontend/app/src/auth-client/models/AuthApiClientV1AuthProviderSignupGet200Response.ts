...
import type { AuthApiClientV1AuthProviderSignupGet200ResponseData } from './AuthApiClientV1AuthProviderSignupGet200ResponseData';
import {
    AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSON,
    AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSONTyped,
    AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSON,
    AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSONTyped,
} from './AuthApiClientV1AuthProviderSignupGet200ResponseData';
 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthProviderSignupGet200Response
 */
export interface AuthApiClientV1AuthProviderSignupGet200Response {
    /**
     * 
     * @type {StatusOK}
     * @memberof AuthApiClientV1AuthProviderSignupGet200Response
     */
    status: StatusOK;
    /**
     * 
     * @type {AuthApiClientV1AuthProviderSignupGet200ResponseData}
     * @memberof AuthApiClientV1AuthProviderSignupGet200Response
     */
    data: AuthApiClientV1AuthProviderSignupGet200ResponseData;
}



/**
 * Check if a given object implements the AuthApiClientV1AuthProviderSignupGet200Response interface.
 */
export function instanceOfAuthApiClientV1AuthProviderSignupGet200Response(value: object): value is AuthApiClientV1AuthProviderSignupGet200Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseFromJSON(json: any): AuthApiClientV1AuthProviderSignupGet200Response {
    return AuthApiClientV1AuthProviderSignupGet200ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthProviderSignupGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': AuthApiClientV1AuthProviderSignupGet200ResponseDataFromJSON(json['data']),
    };
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseToJSON(json: any): AuthApiClientV1AuthProviderSignupGet200Response {
    return AuthApiClientV1AuthProviderSignupGet200ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AuthProviderSignupGet200ResponseToJSONTyped(value?: AuthApiClientV1AuthProviderSignupGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AuthApiClientV1AuthProviderSignupGet200ResponseDataToJSON(value['data']),
    };
}
