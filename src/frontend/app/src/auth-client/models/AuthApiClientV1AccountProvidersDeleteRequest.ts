 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountProvidersDeleteRequest
 */
export interface AuthApiClientV1AccountProvidersDeleteRequest {
    /**
     * The provider ID.
     * 
     * @type {string}
     * @memberof AuthApiClientV1AccountProvidersDeleteRequest
     */
    provider: string;
    /**
...
/**
 * Check if a given object implements the AuthApiClientV1AccountProvidersDeleteRequest interface.
 */
export function instanceOfAuthApiClientV1AccountProvidersDeleteRequest(value: object): value is AuthApiClientV1AccountProvidersDeleteRequest {
    if (!('provider' in value) || value['provider'] === undefined) return false;
    if (!('account' in value) || value['account'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountProvidersDeleteRequestFromJSON(json: any): AuthApiClientV1AccountProvidersDeleteRequest {
    return AuthApiClientV1AccountProvidersDeleteRequestFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountProvidersDeleteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountProvidersDeleteRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountProvidersDeleteRequestToJSON(json: any): AuthApiClientV1AccountProvidersDeleteRequest {
    return AuthApiClientV1AccountProvidersDeleteRequestToJSONTyped(json, false);
}

export function AuthApiClientV1AccountProvidersDeleteRequestToJSONTyped(value?: AuthApiClientV1AccountProvidersDeleteRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
