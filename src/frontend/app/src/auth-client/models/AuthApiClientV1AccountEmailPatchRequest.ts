 ...
 * 
 * @export
 * @interface AuthApiClientV1AccountEmailPatchRequest
 */
export interface AuthApiClientV1AccountEmailPatchRequest {
    /**
     * An email address.
     * 
     * @type {string}
     * @memberof AuthApiClientV1AccountEmailPatchRequest
     */
    email: string;
    /**
     * Primary flag.
...
/**
 * Check if a given object implements the AuthApiClientV1AccountEmailPatchRequest interface.
 */
export function instanceOfAuthApiClientV1AccountEmailPatchRequest(value: object): value is AuthApiClientV1AccountEmailPatchRequest {
    if (!('email' in value) || value['email'] === undefined) return false;
    if (!('primary' in value) || value['primary'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AccountEmailPatchRequestFromJSON(json: any): AuthApiClientV1AccountEmailPatchRequest {
    return AuthApiClientV1AccountEmailPatchRequestFromJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPatchRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AccountEmailPatchRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AccountEmailPatchRequestToJSON(json: any): AuthApiClientV1AccountEmailPatchRequest {
    return AuthApiClientV1AccountEmailPatchRequestToJSONTyped(json, false);
}

export function AuthApiClientV1AccountEmailPatchRequestToJSONTyped(value?: AuthApiClientV1AccountEmailPatchRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
