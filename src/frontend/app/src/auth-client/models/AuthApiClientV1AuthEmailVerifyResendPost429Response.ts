 ...
 * 
 * @export
 * @interface AuthApiClientV1AuthEmailVerifyResendPost429Response
 */
export interface AuthApiClientV1AuthEmailVerifyResendPost429Response {
    /**
     * 
     * @type {number}
     * @memberof AuthApiClientV1AuthEmailVerifyResendPost429Response
     */
    status: AuthApiClientV1AuthEmailVerifyResendPost429ResponseStatusEnum;
}
 ...
 * @export
 */
export const AuthApiClientV1AuthEmailVerifyResendPost429ResponseStatusEnum = {
    NUMBER_429: 429
} as const;
export type AuthApiClientV1AuthEmailVerifyResendPost429ResponseStatusEnum = typeof AuthApiClientV1AuthEmailVerifyResendPost429ResponseStatusEnum[keyof typeof AuthApiClientV1AuthEmailVerifyResendPost429ResponseStatusEnum];


/**
 * Check if a given object implements the AuthApiClientV1AuthEmailVerifyResendPost429Response interface.
 */
export function instanceOfAuthApiClientV1AuthEmailVerifyResendPost429Response(value: object): value is AuthApiClientV1AuthEmailVerifyResendPost429Response {
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function AuthApiClientV1AuthEmailVerifyResendPost429ResponseFromJSON(json: any): AuthApiClientV1AuthEmailVerifyResendPost429Response {
    return AuthApiClientV1AuthEmailVerifyResendPost429ResponseFromJSONTyped(json, false);
}

export function AuthApiClientV1AuthEmailVerifyResendPost429ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthApiClientV1AuthEmailVerifyResendPost429Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AuthApiClientV1AuthEmailVerifyResendPost429ResponseToJSON(json: any): AuthApiClientV1AuthEmailVerifyResendPost429Response {
    return AuthApiClientV1AuthEmailVerifyResendPost429ResponseToJSONTyped(json, false);
}

export function AuthApiClientV1AuthEmailVerifyResendPost429ResponseToJSONTyped(value?: AuthApiClientV1AuthEmailVerifyResendPost429Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
